...
SetFlags() {
	...
	export GCCFLAGS="-O3 -march=${ARCHITECTURELEVEL:-x86-64} -mtune=generic -s -fuse-linker-plugin -Wl,--as-needed -Wl,-O1 -ftree-loop-distribute-patterns -fno-semantic-interposition -fno-trapping-math -Wl,-sort-common -fivopts -fmodulo-sched"
	export CLANGFLAGS="-O3 -march=${ARCHITECTURELEVEL:-x86-64} -mtune=generic"
