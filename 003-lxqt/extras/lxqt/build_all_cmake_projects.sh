...
do
	...
	cmake $ALL_CMAKE_FLAGS -DCMAKE_CXX_FLAGS:STRING="-g -O3 -feliminate-unused-debug-types -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -Wformat -Wformat-security -m64 -fasynchronous-unwind-tables -Wp,-D_REENTRANT -ftree-loop-distribute-patterns -Wl,-z -Wl,now -Wl,-z -Wl,relro -fno-semantic-interposition -ffat-lto-objects -fno-trapping-math -Wl,-sort-common -Wl,--enable-new-dtags -mtune=skylake -fvisibility-inlines-hidden -Wl,--enable-new-dtags -flto -fuse-linker-plugin" .. && "$CMAKE_MAKE_PROGRAM" -j$JOB_NUM || exit 1
