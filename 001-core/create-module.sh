...
strip_clean --exceptions='ld-linux*,libc.so.*,libgcc_s*,libldap*,libpthread*,libstdc++*'
strip_hard_all --exceptions='ld-linux*,libc.so.*,libgcc_s*,libldap*,libpthread*,libstdc++*'
